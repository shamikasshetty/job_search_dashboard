...
TARGET_INCLUDE = ['security analyst','soc analyst','grc','iam analyst','iam engineer',
                  'information security','cybersecurity','security operations',
                  'data analyst','risk analyst','compliance analyst','identity']
TARGET_EXCLUDE = ['intern','seasonal','warehouse','administrative','coordinator',
                  'patient','driver','part-time','hr data','marketing',
                  'customer success','school','beauty','front office',
                  'material data','financial data','actuarial','quality data']
